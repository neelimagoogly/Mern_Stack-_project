...
export default class Dashboard extends Component {
  ...
  getProduct = () => {
    ...
    axios.get(`https://backendagrofam.herokuapp.com/get-product${data}`, {
      headers: {
  ...
  deleteProduct = (id) => {
    axios.post('https://backendagrofam.herokuapp.com/delete-product', {
      id: id
    }, {
      headers: {
  ...
  addProduct = () => {
    ...
    axios.post('https://backendagrofam.herokuapp.com/add-product', file, {
      headers: {
  ...
  updateProduct = () => {
    ...
    axios.post('https://backendagrofam.herokuapp.com/update-product', file, {
      headers: {
        'content-type': 'multipart/form-data',
        'token': this.state.token
      }
    ...
    return (
      <div>
        ...
        <Dialog
          ...
          aria-describedby="alert-dialog-description"
        >
          <DialogTitle id="alert-dialog-title">Add Commodity</DialogTitle>
          <DialogContent>
            <TextField
              id="standard-basic"
              type="text"
